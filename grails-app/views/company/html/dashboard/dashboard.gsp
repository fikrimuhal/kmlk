                    ...
                    <div class="panel-body pull-in text-center">
                        <div class="inline">
                            <div class="easypiechart" data-percent="75" data-bar-color="#576879">
                                <span class="h2"
                                      style="margin-left:10px;margin-top:10px;display:inline-block">75</span>%
            ...
            <ul class="list-group">
                <li class="list-group-item">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <div class="sparkline" data-type="bar" data-bar-color="#8e98a9" data-bar-width="10"
                                 data-height="28"><!--20,10,15,21,12,5,21,30,24,15,8,19--></div>
                            <ul class="list-inline text-muted axis"><li>12<br>a
                            </li><li>2</li><li>4</li><li>6</li><li>8</li><li>10</li><li>12<br>p
                            </li><li>2</li><li>4</li><li>6</li><li>8</li><li>10</li></ul>
                        </div>
                    </div>
                </li>
                <li class="list-group-item">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <div class="sparkline" data-type="bar" data-bar-color="#13c4a5" data-bar-width="10"
                                 data-height="28"><!--200,400,500,100,90,1200,1500,1000,800,500,80,50--></div>
                            <ul class="list-inline text-muted axis"><li>12<br>a
                            </li><li>2</li><li>4</li><li>6</li><li>8</li><li>10</li><li>12<br>p
                            </li><li>2</li><li>4</li><li>6</li><li>8</li><li>10</li></ul>
                        </div>
                ...
                <li class="list-group-item">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <div class="sparkline" data-type="bar" data-bar-color="#61a1e1" data-bar-width="10"
                                 data-height="28"><!--15,21,30,24,15,8,19,20,10,15,21,12--></div>
                            <ul class="list-inline text-muted axis"><li>12<br>a
                            </li><li>2</li><li>4</li><li>6</li><li>8</li><li>10</li><li>12<br>p
                            </li><li>2</li><li>4</li><li>6</li><li>8</li><li>10</li></ul>
                        </div>
    ...
    <div class="col-lg-12">
        ...
        <section class="comment-list block">
            <article id="comment-id-1" class="comment-item media arrow arrow-left">
                <a class="pull-left thumb-small avatar"><img src="/first/images/avatar.jpg" class="img-circle"></a>
