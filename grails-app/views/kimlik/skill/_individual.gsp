<div ng-repeat="skill in skills" id="_skill_{{skill.name}}">
    <!-- Slider -->
    ...
    <div class="heading-buttons">
        ...
        <div class="buttons pull-right">
            <a ng-click="removeSkill(skill)" href="">sil</a>
        </div>
    </div>
    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <a ng-click="rateSelf(skill.name,2)" ng-class="{'selected': skill.self_score==2}" class="rateLink "
               href="">Giriş seviyesi / Öğrenmekteyim</a> |
            ...
            <a ng-click="rateSelf(skill.name,4)" ng-class="{'selected': skill.self_score==4}" class="rateLink"
               href="">İyi / Çok iyi</a> |
            <a ng-click="rateSelf(skill.name,5)" ng-class="{'selected': skill.self_score==5}" class="rateLink"
               href="">Uzman</a>
        </div>
    </div>
