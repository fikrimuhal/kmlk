        ...
        %{--<section class="panel">--}%
            <header class="panel-heading text-right">
                <ul class="nav nav-tabs pull-left">
                    ...
                    <li ng-class="{active: $routeSegment.contains('profilePicture')}"><a href="/kimlik/{{user_name}}/settings/profilePicture"><i class="icon-picture icon-large text-default"></i> Profil resmim</a></li>
