        ...
        %{--<section class="panel">--}%
            <header class="panel-heading text-right">
                <ul class="nav nav-tabs pull-left">
                    ...
                    <li ng-class="{active: $routeSegment.contains('skills')}"><a href="/kimlik/{{user_name}}/settings/skills"><i class="fa  fa-bar-chart-o icon-large text-default"></i> Beceri ve Yeterlilikler</a></li>
                    <li ng-class="{active: $routeSegment.contains('social')}"><a href="/kimlik/{{user_name}}/settings/social"><i class="fa fa-chain icon-large text-default"></i> Sosyal Hesaplarım</a></li>
                    ...
                    <li ng-class="{active: $routeSegment.contains('www')}"><a href="/kimlik/{{user_name}}/settings/www"><i class="fa fa-globe icon-large text-default"></i> Web Sayfası</a></li>
