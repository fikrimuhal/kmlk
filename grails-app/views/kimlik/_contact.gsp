...
<h3 class="glyphicons envelope"><i></i>Bana erişin</h3>
<div class="row-fluid">
    <div class="span6">
        <div class="well" id="contact_gmap"></div>
    </div>
    <div class="span6">
        <h4>Bana mesaj yollayın</h4>
        <form class="row-fluid">
            <input type="text" class="span12" name="name" placeholder="İsminiz" /><br/>
            <input type="text" class="span12" name="phone" placeholder="Tel" /><br/>
            <textarea name="message" class="span12" rows="5" placeholder="Mesaj"></textarea><br/>
