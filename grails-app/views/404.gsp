...
<head>
    ...
    <link href="/common/theme/css/style-default-menus-dark.css" rel="stylesheet" type="text/css" />
    ...
    <div class="container">
        ...
        <div class="hero-unit well">
            ...
            <div class="row-fluid">
                ...
                <div class="span6">
                    <div class="center">
                        <p>Is this a serious error? <a href="todo">Let us know</a></p>
                        <div class="row-fluid">
                            <div class="span6">
                                <a href="/dashboard" class="btn btn-icon-stacked btn-block btn-success glyphicons user_add"><i></i><span>Go back to</span><span class="strong">FLAT KIT's Homepage</span></a>
                            </div>
                            <div class="span6">
                                <a href="/todo" class="btn btn-icon-stacked btn-block btn-danger glyphicons circle_question_mark"><i></i><span>Browse through our</span><span class="strong">Support Centre</span></a>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- Holder Plugin -->
<script src="/common/theme/scripts/plugins/other/holder/holder.js?1374506528"></script>

<!-- Uniform Forms Plugin -->
<script src="/common/theme/scripts/plugins/forms/pixelmatrix-uniform/jquery.uniform.min.js"></script>

<!-- MegaMenu -->
<script src="/common/theme/scripts/demo/megamenu.js"></script>
