...
<div id="login">
    ...
    <div class="wrapper signup">
        <h1 class="glyphicons user_add">Kayıt ol <i></i> <small><br>Asağida ki platformlarda hesabin var ise <strong
                style="font-style: italic">hemen</strong> profilini olustura bilirsin.</small></h1>
        <!-- Box -->
            ...
            <div class="widget-body">
                ...
                <form method="post" action="">
                    ...
                    <div class="row-fluid row-merge">
                        ...
                        <div class="span6">
                            <div class="innerR">
                                <oauth:connect provider="linkedin" id="linked-in-connect-link"
                                               class="btn btn-icon-stacked btn-block btn-warning glyphicons linked_in"><i></i><span>Linkedin ile</span><span
                                        class="strong">Kayıt ol</span></oauth:connect>
                                <oauth:connect provider="twitter" id="twitter-connect-link"
                                               class="btn btn-icon-stacked btn-block btn-info glyphicons twitter"><i></i><span>Twitter ile</span><span
                                        class="strong">Kayıt ol</span></oauth:connect>
                            </div>
                        </div>
                        <!-- // Column END -->
                        ...
                        <div class="span6">
                            <div class="innerL">
                                <oauth:connect provider="google" id="google-connect-link"
                                               class="btn btn-icon-stacked btn-block btn-google glyphicons google_plus"><i></i><span>Google ile</span><span
                                        class="strong">Kayıt ol</span></oauth:connect>
                                <oauth:connect provider="facebook" id="facebook-connect-link"
                                               class="btn btn-icon-stacked btn-block btn-facebook glyphicons facebook"><i></i><span>Facebook ile</span><span
                                        class="strong">Kayıt ol</span></oauth:connect>
