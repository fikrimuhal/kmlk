    ...
    <div class="bg-light" id="screenshot">
        <div class="container gallery">
            <div class="text-center m-large">
                ...
                <p>Kimlik.IO! yu kullanan bir kaç şirket; Aşağida ki linkler şirketlerin profil sayfasina gider. <small>(geri gelmeyi unutmayın)</small></p>
            </div>
            <div class="row m-large gallery">
                <div class="col-lg-3 col-6">
                    <a href="/company/profile/fikrimuhal" class="thumbnail" target="_blank"><img src="/images/photos/fikrimuhal_logo_medium.png"></a>
                </div>
                <div class="col-lg-3 col-6">
                    <a href="/first/images/render-2.jpg" class="thumbnail"><img src="/first/images/render-2-thumb.jpg"></a>
                </div>
                <div class="col-lg-3 col-6">
