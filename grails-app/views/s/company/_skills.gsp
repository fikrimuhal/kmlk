    ...
    <div class="widget-body">
        ...
        <div class="row-fluid">
            ...
            <div class="span4 offset1">
                <h5 class="strong">Teknik yetenekler</h5>
                <div class="progress progress-mini progress-primary count-outside add-outside"><div class="count">100%</div><div class="bar" style="width: 100%;"></div><div class="add">HTML (x3)</div></div>
                <div class="progress progress-mini progress-primary count-outside add-outside"><div class="count">90%</div><div class="bar" style="width: 90%;"></div><div class="add">CSS (x2)</div></div>
            ...
            <div class="span4 offset1">
                <h5 class="strong">Genel yetenekler</h5>
        ...
        <p>
            Şirket calisanlarinin toplam skilleri. <br>
            Out sourced skiller. <br>
            Skill puanlari baska kisilerin yaptigi siralama + calisanlarin kendi girdigi puanlar ile hesaplaniyor.
